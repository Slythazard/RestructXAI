...
import { ArrowRight, Upload, Database, MessageCircle, BarChart3, Brain } from "lucide-react";
import { useState } from "react";
import { motion } from "motion/react";

export function HeroSection({ onNavigateToChat }: { onNavigateToChat: () => void }) {
        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          >
            <div className="space-y-4">
              ...
              >
                <Badge variant="secondary" className="inline-flex items-center space-x-2 bg-gradient-to-r from-cyan-500/10 to-blue-500/10 border-cyan-500/20 hover:shadow-lg hover:shadow-cyan-500/25 transition-all duration-300">
              ...
              >
                <span className="text-foreground">Harvest Insights from Your</span>{" "}
                <br />
              ...
              >
                Upload PDF documents and instantly chat with them. Extract insights, 
                get summaries, and find answers from your documents using advanced AI.
              </motion.p>
            </div>
            ...
            >
              ...
              >
                <div className="text-2xl font-bold bg-gradient-to-r from-cyan-400 to-blue-500 bg-clip-text text-transparent">5M+</div>
                <div className="text-sm text-muted-foreground group-hover:text-foreground transition-colors">PDFs Processed</div>
              </motion.div>
              <motion.div 
                className="group"
                whileHover={{ scale: 1.05 }}
              >
                <div className="text-2xl font-bold bg-gradient-to-r from-blue-400 to-purple-500 bg-clip-text text-transparent">100MB</div>
                <div className="text-sm text-muted-foreground group-hover:text-foreground transition-colors">Max File Size</div>
              </motion.div>
              <motion.div 
                className="group"
                whileHover={{ scale: 1.05 }}
              >
                <div className="text-2xl font-bold bg-gradient-to-r from-purple-400 to-cyan-500 bg-clip-text text-transparent">99.9%</div>
          ...
          >
            ...
            />
            <Card className={`relative border-2 border-dashed transition-all duration-500 ${
              dragActive 
            ...
            >
              ...
              >
                <div className="flex-1 bg-gradient-to-r from-cyan-500/90 to-blue-600/90 backdrop-blur-sm text-white p-3 rounded-lg rounded-tr-none max-w-xs shadow-lg shadow-blue-500/25">
                  <p className="text-sm">The paper presents three key findings: AI models achieve 95% accuracy on benchmark tests, novel architecture reduces training time by 40%, and the approach shows strong generalization across domains...</p>
                </div>
                <motion.div 
